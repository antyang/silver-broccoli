...
/***/ function(module, exports, __webpack_require__) {
	...
	var Landing = __webpack_require__(249);
	var Layout = __webpack_require__(250);
	var Details = __webpack_require__(251);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reduceSearchTerm = function reduceSearchTerm(state, action) {
	  var newState = {}; // sets new empty object
	  ...
	  _createClass(Landing, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(
	          'form',
	          { action: '', onSubmit: this.goToSearch },
	...
	var Details = function (_React$Component) {
	  ...
	  _createClass(Details, [{
	    ...
	    value: function render() {
	      ...
	      var trailerURL = 'https://www.youtube-nocookie.com/embed/' + trailer + '?rel=0&amp;controls=0&amp;showinfo=0';
	      return React.createElement(
	        'div',
	        { className: 'container' },
	        ...
	        React.createElement(
	          ...
	          React.createElement('iframe', { src: trailerURL, frameBorder: '0', allowFullScreen: true })
	        )
	      );
	    }
	  }]);
